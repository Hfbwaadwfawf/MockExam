...
namespace CityPoint.Data
{
    public class SeedData
    {
        ...
        public static async Task SeedBookingsAsync(ApplicationDbContext context, UserManager<IdentityUser> userManager)
        {
            ...
            // Get actual room IDs from database
            var room1 = await context.Room.FirstOrDefaultAsync(r => r.Name == "Executive Boardroom");
            var room2 = await context.Room.FirstOrDefaultAsync(r => r.Name == "Conference Hall");
